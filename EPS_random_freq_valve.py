...
a = np.random.randint(0, 100, nstep)  # range for amplitude
...
time = np.linspace(0,10,4990)
time_1 = np.linspace(0,9,10)

############
    
plt.figure(1)
plt.subplot(511)
plt.plot(solution[:,0]/10**5,color='blue', label='$p_{bh}$')
plt.grid()
plt.legend()
