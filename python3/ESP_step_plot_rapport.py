...
time_2 = np.linspace(0,10,100)

plt.figure(1)
plt.grid()
plt.subplot(411)
plt.grid()
x_1 = plt.plot(time_2, solution[:,0]/10**5,label='$p_{bh}$')
plt.legend()
plt.xlabel('Time [min]')
plt.ylabel('$p_{bh} \ [bar]$')
plt.subplot(412)
x_2 = plt.plot(time_2, solution[:,1]/10**5,label='$p_{wh}$')
plt.legend()
plt.grid()
plt.xlabel('Time [min]')
plt.ylabel('$p_{wh} \ [bar]$')
plt.subplot(413)
x_3 = plt.plot(time_2, solution[:,2]*3600,label='q')
plt.legend()
plt.grid()
plt.xlabel('Time [min]')
